...
We built the Dot Grid Calendar (see [Chapter 2](1.1-chapter-02.md#case-study-the-dot-grid-calendar)) for Basecamp, an existing product. We shaped the project, bet six weeks on it, a team built it, and then we shipped it straight to customers.
